...
/* Created on:     2020/11/28 20:08:37                          */
/*==============================================================*/


alter table 图书简报
   drop constraint FK_图书简报_定位_馆藏位置;

alter table 图书简报
   drop constraint FK_图书简报_定类_图书分类简表;

alter table 图书简报
   drop constraint FK_图书简报_放取_图书管理系统;

alter table 图书分类简表
   drop primary key cascade;

drop table 图书分类简表 cascade constraints;
...
drop table 图书简报 cascade constraints;

alter table 图书管理系统
   drop primary key cascade;

drop table 图书管理系统 cascade constraints;

alter table 读者信息
   drop primary key cascade;

drop table 读者信息 cascade constraints;

alter table 馆藏位置
   drop primary key cascade;

drop table 馆藏位置 cascade constraints;
